...
for f in $changed; do
  ...
  # Quita las comillas envolventes para contar solo los caracteres del texto.
  # wc -m con locale UTF-8 cuenta caracteres, no bytes: "ñ" o "á" valen uno.
